/* APM CETis 61 · v14.2.5 PROTOTIPO
...
*/
window.P2_CORE_CONTINUO_VERSION='14.2.5';
window.P2CoreV1422=(function(){
 ...
 function install(){
   ...
   installObserver();
   // Espera a que core_v14_1 restaure la última respuesta enviada y luego aplica, si existe, un borrador local no enviado.
   setTimeout(()=>{restoreDrafts();restoreSection();setState('✓ Todo guardado','ok')},1100);
 }
