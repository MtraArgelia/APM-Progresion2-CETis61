/* APM CETis 61 · v14.2.3 PROTOTIPO
...
window.P2CoreV1422=(function(){
 ...
 function fieldStatus(a){
   ...
   // En actividades mixtas (objetiva + abierta), basta con que la parte objetiva
   // haya sido comprobada y todas las evidencias estén respondidas. La exactitud
   // NO determina el avance. La respuesta abierta se autoguarda por separado.
