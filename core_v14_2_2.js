/* APM CETis 61 · v14.2.2 PROTOTIPO
   Corrige el avance: escribir ≠ completar.
   Pendiente -> En proceso -> Completada solo tras la acción correspondiente.
...
window.P2CoreV1422=(function(){
 ...
 function fieldStatus(a){
   ...
   // Si además contienen respuesta abierta, deben finalizarse con Continuar.
   if(a.querySelector('textarea') && !committed)return {state:'progress'};
   // Actividades abiertas: Guardar/Continuar confirma que el alumno terminó por ahora.
   if(!hasObjective(a) && !committed)return {state:'progress'};
   // No se completa si aún falta un campo obligatorio.
 ...
 return {saveOpen,updateProgress,logout,showPending,gotoActivity,markChecked};
})();
